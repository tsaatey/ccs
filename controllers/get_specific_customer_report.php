...
if (!empty(filter_input(INPUT_POST, 'card')) && !empty(filter_input(INPUT_POST, 'start_date')) && !empty(filter_input(INPUT_POST, 'end_date'))) {
    $card_number = filter_input(INPUT_POST, 'card');
